...
<body>
    ...
    <center>
        ...
        function Wife1()
        {
            ...
            $skin = "Gori";
            $height = "Very Lambi";
            echo "<br><b>GF 1</b> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            <i style='font-size:12px';>Jaan to pyaari</i><br>Name: " . $name . "<br>Dob: " . $dob . "<br>Skin: " . $skin . "<br>Height: " . $height;
        }
        function Wife2()
        {
            $name = "Kiara Advani";
        ...
        class Shop
        {
            ...
            function display()
            {
                echo "<b>Shop Name: </b>" . $this->shopname . "<br><b>Location: </b>" . $this->loc . "<br>";
            }
        }
        ...
        if (isset($_POST["username"]) || isset($_POST["userpassword"])) {
            echo "Kida " . $_POST['username'] . "<br>Your password is " . $_POST['userpassword'];
            exit();
        }
